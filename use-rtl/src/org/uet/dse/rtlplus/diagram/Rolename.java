...
public final class Rolename extends EdgeProperty {
	 ...
	 * 
	 * @param assocEnd
	 *            The <code>MAassociationEnd</code> this role name belongs to.
	 * @param source
	 *            The <code>NodeBase</code> which represents the class or object
	 *            node this role name is attached to.
	 * @param target
	 *            The <code>NodeBase</code> which represents the class, object or
	 *            diamond node of the opposite end.
	 ...
	 * @param edge
	 */
	Rolename(MAssociationEnd assocEnd, NodeBase source, NodeBase target, WayPoint sourceWayPoint,
			WayPoint targetWayPoint, DiagramOptions opt, int side, EdgeBase edge) {
