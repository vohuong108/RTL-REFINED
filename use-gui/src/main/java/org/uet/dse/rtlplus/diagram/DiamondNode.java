...
public class DiamondNode extends NodeBase {
	...
	private void instanciateAssocName(boolean isLink) {
		fAssocName = new AssociationName(fName, fConnectedNodes, fOpt, this, fAssoc, isLink);
	}
		...
		if (fHalfEdges != null) {
			for (EdgeBase e : fHalfEdges) {
				if (e instanceof AssociationOrLinkPartEdge) {
					...
					String xpathExpr = "./edge[@type='" + LayoutTags.HALFEDGE + "' and edgeproperty[@type='"
							+ LayoutTags.ROLENAME + "' and @kind='" + LayoutTags.TARGET + "']/name='"
