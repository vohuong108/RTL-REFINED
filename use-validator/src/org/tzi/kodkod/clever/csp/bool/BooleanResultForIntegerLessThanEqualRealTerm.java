 ...
 *
 */
public final class BooleanResultForIntegerLessThanEqualRealTerm
		extends AbstractBooleanResultForBinaryIntegerRealArgumentTermWithInfixOperator {

	/** {@inheritDoc} */
	public BooleanResultForIntegerLessThanEqualRealTerm(IIntegerResultTerm left, IRealResultTerm right) {
		super(left, right);
	}
	...
	public void processWith(ITermVisitor iTermVisitor) {
		iTermVisitor.visitBooleanResultForIntegerLessThanEqualRealTerm(this);
	}
