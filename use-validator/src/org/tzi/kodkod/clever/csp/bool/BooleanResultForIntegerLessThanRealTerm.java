 ...
 *
 */
public final class BooleanResultForIntegerLessThanRealTerm
		extends AbstractBooleanResultForBinaryIntegerRealArgumentTermWithInfixOperator {

	/** {@inheritDoc} */
	public BooleanResultForIntegerLessThanRealTerm(IIntegerResultTerm left, IRealResultTerm right) {
		super(left, right);
	}
	...
	public void processWith(ITermVisitor iTermVisitor) {
		iTermVisitor.visitBooleanResultForIntegerLessThanRealTerm(this);
	}
}
