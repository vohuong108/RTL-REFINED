 ...
 *
 */
public final class BooleanResultForRealLessThanIntegerTerm
		extends AbstractBooleanResultForBinaryRealIntegerArgumentTermWithInfixOperator {

	/** {@inheritDoc} */
	public BooleanResultForRealLessThanIntegerTerm(IRealResultTerm left, IIntegerResultTerm right) {
		super(left, right);
	}
	...
	public void processWith(ITermVisitor iTermVisitor) {
		iTermVisitor.visitBooleanResultForRealLessThanIntegerTerm(this);
	}
}
