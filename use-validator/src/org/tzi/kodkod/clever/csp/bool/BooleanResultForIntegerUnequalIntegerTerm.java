 ...
 *
 */
public final class BooleanResultForIntegerUnequalIntegerTerm
		extends AbstractBooleanResultForBinaryIntegerArgumentTermWithInfixOperator {

	/** {@inheritDoc} */
	public BooleanResultForIntegerUnequalIntegerTerm(IIntegerResultTerm left, IIntegerResultTerm right) {
		super(left, right);
	}
	...
	public void processWith(ITermVisitor iTermVisitor) {
		iTermVisitor.visitBooleanResultForIntegerUnequalIntegerTerm(this);
	}
