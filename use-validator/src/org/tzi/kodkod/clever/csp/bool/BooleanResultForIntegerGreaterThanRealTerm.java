 ...
 *
 */
public final class BooleanResultForIntegerGreaterThanRealTerm
		extends AbstractBooleanResultForBinaryIntegerRealArgumentTermWithInfixOperator {

	/** {@inheritDoc} */
	public BooleanResultForIntegerGreaterThanRealTerm(IIntegerResultTerm left, IRealResultTerm right) {
		super(left, right);
	}
	...
	public void processWith(ITermVisitor iTermVisitor) {
		iTermVisitor.visitBooleanResultForIntegerGreaterThanRealTerm(this);
	}
