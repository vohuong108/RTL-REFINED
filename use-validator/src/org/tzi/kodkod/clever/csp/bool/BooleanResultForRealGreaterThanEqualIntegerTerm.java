 ...
 *
 */
public final class BooleanResultForRealGreaterThanEqualIntegerTerm
		extends AbstractBooleanResultForBinaryRealIntegerArgumentTermWithInfixOperator {

	/** {@inheritDoc} */
	public BooleanResultForRealGreaterThanEqualIntegerTerm(IRealResultTerm left, IIntegerResultTerm right) {
		super(left, right);
	}
	...
	public void processWith(ITermVisitor iTermVisitor) {
		iTermVisitor.visitBooleanResultForRealGreaterThanEqualIntegerTerm(this);
	}
}
